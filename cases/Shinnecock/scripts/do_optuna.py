...
import settings_optuna_don as sett
...
don_tuner_epochs = sett.don_tuner_epochs
don_trials = sett.don_trials
...
sys.stdout = open("don_optuna.txt", "w")
#
...
with open('don_trials.txt', 'a') as f:
