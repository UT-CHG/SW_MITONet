...
ae_model_dir = "saved_models_mdon"
...
def NN():
    ...
    neurons_layer = sett.neurons_layer
    ...
    b_encoder_neurons = sett.b_encoder_neurons
    ...
    t_encoder_neurons = sett.t_encoder_neurons    
